...
Module::Module(const uint8_t& wire, const uint8_t& mux, const uint8_t& eeprom_addr) : wire(wire), mux(mux), eeprom(new EEPROM(createFQA(wire, mux, I2CIP_MUX_BUS_DEFAULT, eeprom_addr))) {
